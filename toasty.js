...
(function () {
  ...
  var NAV_H = 72; /* înălțimea navbar-ului fix */
  ...
  style.textContent = [
    ...
    /* Overlay — pe desktop începe sub navbar */
    '#ty-ov{position:fixed;inset:0;background:rgba(0,21,42,.4);z-index:2147483645;',
    ...
    /* Desktop: panel sub navbar, fără a-l acoperi */
    ...
    'padding:9px 15px;font-size:13px;color:#0f2942;background:#fff;',
    ...
    '#ty-inp:focus{border-color:#00537f;background:#fff;box-shadow:0 0 0 3px rgba(0,83,127,.1);}',
  ...
  win.innerHTML = [
    ...
    /* Header — gradient identic cu navbar */
    ...
    'flex-shrink:0;min-height:68px;">',
      ...
      ' style="all:unset;width:36px;height:36px;border-radius:50%;background:rgba(255,255,255,.12);',
      'display:flex;align-items:center;justify-content:center;cursor:pointer;flex-shrink:0;',
    ...
    /* Input */
    '<div style="padding:12px 14px 16px;border-top:1px solid #dde6ee;',
  ...
  function showTyping() {
    ...
    row.innerHTML = avatarEl() +
      ...
      '<span style="width:6px;height:6px;background:#8faab8;border-radius:50%;animation:tyDot 1.2s infinite"></span>' +
      '<span style="width:6px;height:6px;background:#8faab8;border-radius:50%;animation:tyDot 1.2s infinite .2s"></span>' +
      '<span style="width:6px;height:6px;background:#8faab8;border-radius:50%;animation:tyDot 1.2s infinite .4s"></span>' +
      '</div>';
    msgs.appendChild(row);
    msgs.scrollTop = msgs.scrollHeight;
    return id;
