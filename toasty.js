...
(function () {
  ...
  style.textContent = [
    ...
    'background:radial-gradient(ellipse 70% 50% at 12% 18%,rgba(0,83,127,.07) 0%,transparent 65%),',
    'radial-gradient(ellipse 60% 65% at 88% 78%,rgba(0,45,71,.06) 0%,transparent 65%),#fff;',
  ...
  win.innerHTML = [
    ...
    '<div id="ty-msgs" role="log" aria-live="polite" aria-relevant="additions">',
      ...
      '<div id="ty-chips" style="display:flex;flex-direction:column;align-items:flex-start;gap:6px;padding:6px 0 4px 36px;">',
        ...
        '</button>',
        '<button class="ty-chip" onclick="toastySend(\'Cât costă membralitatea?\')">',
