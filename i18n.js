...
(function () {
  ...
  var T = {
    ...
    /* ─ Cookies / Privacy / GDPR page ─ */
    'ck-hero-h1':       'Legal <span class="text-gold">policy</span>',
    'ck-hero-tags':     'Cookies &nbsp;·&nbsp; GDPR &nbsp;·&nbsp; Privacy',
    'ck-hero-updated':  'Last updated: <strong class="text-white/55">June 2026</strong> &nbsp;·&nbsp; Timișoara Toastmasters Club',
    'ck-1-h2':          '1. What are cookies?',
    'ck-1-p1':          'Cookies are small text files stored on your device when you visit a website. They let the site remember your preferences, function correctly, and in some cases collect usage statistics.',
    'ck-1-p2':          'Besides classic cookies (stored in the browser), our site also uses <strong>localStorage</strong>, a similar mechanism, also in your browser, which doesn\'t expire automatically and isn\'t sent to the server with every request. Data in localStorage is accessible only to your browser, on your device.',
    'ck-1-p3':          'By continuing to browse <strong>timisoaratoastmasters.ro</strong>, you agree to the use of the storage described in this policy. If you don\'t agree, you can delete this data anytime from your browser settings or decline the consent banner.',
    'ck-2-h2':          '2. What we store in your browser',
    'ck-2-p1':          'The Timișoara Toastmasters site doesn\'t use tracking, advertising, or behavioral analysis cookies. We only store functional data, directly in your browser, without sending it to our servers.',
    'ck-2-p2':          'We don\'t install session, authentication, advertising, remarketing, or any behavioral analysis cookies of any kind.',
    'ck-table-key':       'Key (localStorage)',
    'ck-table-type':      'Type',
    'ck-table-purpose':   'Purpose',
    'ck-table-duration':  'Duration',
    'ck-table-functional':'Functional',
    'ck-table-permanent': 'Permanent (until manually cleared)',
    'ck-row1-purpose':  'Remembers whether you accepted or declined the cookie banner, so it isn\'t shown again on every visit',
    'ck-row2-purpose':  'Your consent value (accepted / declined), used to enable or disable optional features',
    'ck-row3-purpose':  'The language you selected on the site (Romanian / English), remembered for future visits',
    'ck-row4-purpose':  'A local backup of the data you entered in the contact form, kept only in your browser, so you don\'t lose it if an error occurs',
    'ck-row4-duration': 'Permanent (until manually cleared or the form is submitted)',
    'ck-3-h2':          '3. Third-party services',
    'ck-3-p1':          'When you visit the site, your browser may automatically connect to a few external services required for the site to work technically. These services may store their own cookies, over which we have no direct control.',
    'ck-3-gf-h3':       'Google Fonts',
    'ck-3-gf-p':        'We use Google Fonts to display the site\'s typefaces (<em>Plus Jakarta Sans</em> and <em>Inter</em>). When the page loads, your browser makes a request to Google\'s servers, which may log your IP address. We have no access to this data. See <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">Google\'s Privacy Policy</a> for details.',
    'ck-3-toasty-h3':   'Toasty, AI Assistant (Anthropic Claude)',
    'ck-3-toasty-p':    'The site includes a conversational assistant called Toasty. When you send a message, the text is securely transmitted to the Anthropic Claude API to generate a reply. The conversation isn\'t saved on our servers after you close the session. Timișoara Toastmasters isn\'t the data controller for the processing done by Anthropic. See <a href="https://www.anthropic.com/privacy" target="_blank" rel="noopener noreferrer">Anthropic\'s Privacy Policy</a>.',
    'ck-3-cloud-h3':    'Cloudinary',
    'ck-3-cloud-p':     'The images in the photo gallery are hosted on Cloudinary, a media management service. Cloudinary serves the images in an optimized way and doesn\'t store personal data about visitors. See <a href="https://cloudinary.com/privacy" target="_blank" rel="noopener noreferrer">Cloudinary\'s Policy</a>.',
    'ck-3-social-h3':   'Social networks',
    'ck-3-social-p':    'The buttons in the footer (Instagram, Facebook, LinkedIn, WhatsApp) are simple external links. They <strong>do not</strong> install cookies or trackers on our site. Once you visit one of these platforms, their own privacy policies apply:',
    'ck-3-social-li1':  'Instagram Policy',
    'ck-3-social-li2':  'Facebook / Meta Policy',
    'ck-3-social-li3':  'LinkedIn Policy',
    'ck-3-social-li4':  'WhatsApp Policy',
    'ck-4-h2':          '4. Your rights (GDPR)',
    'ck-4-p1':          'Under the <a href="https://legislatie.just.ro/Public/DetaliiDocumentAfis/201834" target="_blank" rel="noopener noreferrer">European GDPR Regulation (EU 2016/679)</a>, you have the following rights regarding your personal data:',
    'ck-4-li1':         '<strong>Right of access:</strong> you can request a copy of the data we hold about you',
    'ck-4-li2':         '<strong>Right to erasure:</strong> you can request the removal of your personal data',
    'ck-4-li3':         '<strong>Right to rectification:</strong> you can request correction of inaccurate data',
    'ck-4-li4':         '<strong>Right to portability:</strong> you can request your data in a structured, standard format',
    'ck-4-li5':         '<strong>Right to object:</strong> you can refuse the processing of your data in certain circumstances',
    'ck-4-li6':         '<strong>Right to withdraw consent:</strong> you can revoke your consent at any time, without affecting prior processing',
    'ck-4-p2':          'Data stored locally (cookie preferences, language, form) resides <strong>only in your browser</strong>, not on our servers. You can delete it anytime directly from your browser, without contacting us.',
    'ck-4-p3':          'For any request regarding personal data submitted through the contact form, you can write to us at the address in section 6.',
    'ck-5-h2':          '5. Managing your preferences',
    'ck-5-p1':          'You can delete all data stored by the site anytime from your browser settings:',
    'ck-5-li1':         '<strong>Chrome / Edge:</strong> Settings → Privacy and security → Clear browsing data → Site data and cookies',
    'ck-5-li2':         '<strong>Firefox:</strong> Settings → Privacy and security → Cookies and site data → Clear data',
    'ck-5-li3':         '<strong>Safari:</strong> Preferences → Privacy → Manage site data → Remove all',
    'ck-5-li4':         '<strong>Samsung Internet:</strong> Settings → Privacy → Clear browsing data → Cookies and site data',
    'ck-5-p2':          'If you disable local storage, the cookie banner will reappear on every visit, and your language preference won\'t be remembered.',
    'ck-6-h2':          '6. Contact',
    'ck-6-p1':          'For questions about this policy or your personal data, you can reach us through:',
    'ck-6-li1':         'The contact form',
    'ck-6-li1b':        'on the site',
